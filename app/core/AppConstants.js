...
export default {
  ...
  HOMEPAGE_URL: process.env.MM_HOMEPAGE || 'https://browser.nxttechnologies.io/',
  ...
  FIAT_ORDERS: {
    ...
    WYRE_MERCHANT_ID: 'merchant.io.nxtwallet.wyre',
    WYRE_MERCHANT_ID_TEST: 'merchant.io.nxtwallet.wyre.test',
  ...
  URLS: {
    ...
    PRIVACY_POLICY: 'https://www.nxttechnologies.io/privacy-policy',
    CONNECTIVITY_ISSUES:
  ...
  BUNDLE_IDS: {
    IOS: 'io.nxtwallet.NxtWallet',
    ANDROID: 'io.nxtwallet',
  },

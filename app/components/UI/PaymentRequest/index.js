...
class PaymentRequest extends PureComponent {
  ...
  handleFiatPrimaryCurrency = (amount) => {
    ...
    if (selectedAsset.symbol !== 'NXT' && exchangeRate && exchangeRate !== 0) {
  ...
  renderEnterAmount = () => {
    ...
    if (!conversionRate) {
      switchable = false;
    } else if (selectedAsset.symbol !== 'NXT' && !exchangeRate) {
      switchable = false;
    }
    return (
            ...
            <View style={styles.ethContainer}>
              <View style={styles.amounts}>
                ...
                <View style={styles.secondaryAmount}>
                  {secondaryAmount && internalPrimaryCurrency === 'NXT' && (
